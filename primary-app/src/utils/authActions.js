...
// TODO: Use databse connection and API calls for authentication instead of hardcoded values
// TODO: Replace hardcoded API base URL with environment variable
...
export const handleLogin = (credentials) => async (dispatch, navigate) => {
    try {
        dispatch(loginStart());
